...
const server=express()
  ...
  .use(session({secret:'sandrinqwerty',resave: true,saveUninitialized: true}))
  ...
  .get('/proctored', (req, res) => {
    ...
    if(!req.query.name  && !req.query.id && !req.query.room)
      ...
      res.render('pages/candidate',{room:req.query.room,ice:iceServers,name:req.query.name,id:req.query.id,rname:req.query.rname})
    }
    else{
      res.render('pages/proctored')
    }
